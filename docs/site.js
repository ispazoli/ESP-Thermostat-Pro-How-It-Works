...
const I18N = {
  "hu": {
    ...
    "arch_hw_p": "Képernyőképek és fotók a repódból (ESP32 UI + ESP‑01 relé egység).",
  ...
  "en": {
    ...
    "arch_hw_p": "Screenshots and photos from your repository (ESP32 UI + ESP‑01 relay unit).",
...
function applyI18n(lang) {
  const dict = (I18N && I18N[lang]) ? I18N[lang] : (I18N.en || {});
  document.querySelectorAll('[data-i18n]').forEach(el => {
    const key = el.getAttribute('data-i18n');
    const isHtml = el.getAttribute('data-i18n-html') === '1';
    const v = dict[key];
    if (v === undefined) return; // keep existing content if missing
...
function init() {
  ...
  // Default language: Hungarian (unless user selected otherwise)
